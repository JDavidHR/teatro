...
if(isset($_GET['id']) && !empty($_GET['id'])){
    ...
    $ActualizarEstado = $mysql->efectuarConsulta("update personajes set estado = 1 where id =".$idPersonaje.""); 
    ...
    if($ActualizarEstado){
       ...
       header("Location: ../ver_personaje.php");
        ...
        echo "<div class=\"alert alert-warning alert-dismissible\"><a href=\"../ver_personaje_inactivo.php\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">&times;</a><strong>Alerta!</strong> No se ha podido habilitar el personaje.</div>";
        //redireccion
        header( "refresh:3;url=../ver_personaje_inactivo.php" );
    }
}else{
