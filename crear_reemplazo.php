...
<head>
  ...
  <title>Teatro Cotecnova - Nuevo Reemplazo</title>
...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
  ...
  <?php 
    ...
    $seleccionFuncion  =  $mysql->efectuarConsulta ( "SELECT  teatro.funciones.id, teatro.funciones.fecha_hora from funciones ");
    //funcion desconectar
    $mysql->desconectar();    
    ?>
  </div>  
        ...
        <div class="col-md-8 col-sm-8">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form class="form-horizontal form-material" action="Controlador/insertarReemplazo.php" method="POST">
                
                <div class="form-group">
                  <label class="col-sm-12">Nombre del Reemplazo</label>
                  <div class="col-sm-12">
                      <input type="text" name="nombre_reemplazo" placeholder="Nombre del Reemplazo" class="form-control form-control-line">
                  </div>
                </div> 

                <div class="form-group">
                    <label class="col-sm-12">Actor a Reemplazar</label>
                    <div class="col-sm-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <select class="form-control form-control-line" name="tipo_fun">
                          <!-- Llamado al ciclo while donde vamos a recorrer un array asociativo con la consulta declarada anteriormente -->
                          <option value="0">Elija una funcion</option>   
                        <?php 
                        //cliclo while que nos servira para traer los datos que haya seleccionado en la cedula
                            while ($resultado = mysqli_fetch_assoc($seleccionFuncion)){   
                        ?> 
                          <!-- Se traen los datos y se imprimen en las opciones del select -->
                        
                          <!-- impresion de los datos traidos en el select con sus respectivas variables -->
                        <option value="<?php echo $resultado['id']?>"><?php echo $resultado['fecha_hora'];?></option> 
                        <?php }?>
                    </select>
                  </div>
                </div>
