...
<head>
  ...
  <title>Teatro Cotecnova - Eliminar reemplazo</title>
...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
  <div id="container">
    ...
    <?php
            ...
            $seleccionInformacion = $mysql->efectuarConsulta("select teatro.reemplazos.id as id_reemplazo, teatro.reemplazos.nombre from reemplazos where id = ".$id."");
            //funcion desconectar
            $mysql->desconectar();    
            while ($resultado= mysqli_fetch_assoc($seleccionInformacion)){
                $idReemplazo = $resultado['id_reemplazo'];
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="card">
            <!-- Tab panes -->
            <div class="card-body">
              <form class="form-horizontal form-material" method="post" action="Controlador/eliminarReemplazo.php?id=<?php echo $id;?>">
                  <div class="form-group">
                    <label class="col-sm-12">Id del reemplazo</label>
                    <div class="col-md-12">
                      <!-- Se traen los datos y se imprimen en las opciones del select -->
                      <input type="text" disabled="" value="<?php echo $idReemplazo?>" class="form-control form-control-line">
                    </div>
                  </div>
