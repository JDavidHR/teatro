...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    <?php 
        ...
        $consulta = $mysql->efectuarConsulta("SELECT teatro.obra.id as idObra, teatro.obra.nombre as nombre, teatro.autor.nombre as autor, teatro.tipo_obra.nombre as tipo, teatro.director.nombre as director from teatro.obra join teatro.autor on teatro.obra.Autor_id = teatro.autor.id join teatro.tipo_obra on teatro.tipo_obra.id = teatro.obra.Tipo_obra_id join teatro.director on teatro.obra.Director_id = teatro.director.id where estado = 0");
        //funcion desconectar
        $mysql->desconectar();    
        ?>
    </div>  
                ...
                <table class="table table-hover" id="ver_medico">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <th scope="row"><?php echo $resultado['autor'] ?></th>
